...
# Sample dataset
df = pd.read_csv(r"C:\Users\acer\OneDrive\Desktop\internshif file\All_csv_file\sample_customer_csv file.csv")  # Must contain 'features' & 'target' columns
...
st.title("  LOOK MY CLV Evaluation Dashboard")
